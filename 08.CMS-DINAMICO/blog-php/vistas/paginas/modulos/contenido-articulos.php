		...
		<div class="row">
			...
			<div class="col-12 col-md-8 col-lg-9 p-0 pr-lg-5">
				...
				<div class="container">
					...
					<img src="<?=$blog['dominio']?>vistas/img/articulo.png" alt="Lorem ipsum dolor sit amet" class="img-fluid my-lg-3">
					...
					<img src="<?=$blog['dominio']?>vistas/img/ad04.png" class="img-fluid my-3" width="100%">
							...
							<ul class="slide-area">
								...
								<li class="px-3">
									...
									<a href="articulos.html" class="text-secondary">
										...
										<img src="<?=$blog['dominio']?>vistas/img/articulo04.png" alt="Lorem ipsum dolor sit amet" class="img-fluid">
					...
					<div class="row opiniones">
						...
						<div class="col-3 col-sm-4 col-lg-2 p-2">
							...
							<img src="<?=$blog['dominio']?>vistas/img/user01.jpg" class="img-thumbnail">	
						...
						<div class="col-3 col-sm-4 col-lg-2 p-2">
							...
							<img src="<?=$blog['dominio']?>vistas/img/user02.jpg" class="img-thumbnail">	
					...
					<form>
						...
						<div class="row">
							...
							<div class="d-none d-md-block col-md-4 col-lg-3">
								...
								<img src="<?=$blog['dominio']?>vistas/img/subirFoto.png" class="img-fluid mt-md-3 mt-xl-2">
					...
					<img src="<?=$blog['dominio']?>vistas/img/ad01.jpg" class="img-fluid my-3 d-block d-md-none" width="100%">
			...
			<div class="d-none d-md-block pt-md-4 pt-lg-0 col-md-4 col-lg-3">		
					...
					<div class="d-flex my-3">
						...
						<div class="w-100 w-xl-50 pr-3 pt-2">
							...
							<a href="articulos.html">
								...
								<img src="<?=$blog['dominio']?>vistas/img/articulo05.png" alt="Lorem ipsum dolor sit amet" class="img-fluid">
					...
					<div class="d-flex my-3">
						...
						<div class="w-100 w-xl-50 pr-3 pt-2">
							...
							<a href="articulos.html">
								...
								<img src="<?=$blog['dominio']?>vistas/img/articulo06.png" alt="Lorem ipsum dolor sit amet" class="img-fluid">
					...
					<div class="d-flex my-3">
						...
						<div class="w-100 w-xl-50 pr-3 pt-2">
							...
							<a href="articulos.html">
								...
								<img src="<?=$blog['dominio']?>vistas/img/articulo07.png" alt="Lorem ipsum dolor sit amet" class="img-fluid">
				...
				<div class="my-4">
					...
					<img src="<?=$blog['dominio']?>vistas/img/ad06.png" class="img-fluid">
